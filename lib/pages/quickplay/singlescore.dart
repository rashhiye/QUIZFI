...
//import 'package:myapp/pages/client/score.dart';
...
class ScoreBoardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double n=double.parse(scores[0]);
    double d=double.parse(scores[1]);
    double t=double.parse(scores[2]);
    double f=double.parse(scores[3]);
    double ti=double.parse(scores[5]);
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: AssetImage(
                          'assets/images/avatar/${HomePage.avatar}.png'),
                    ),
                    // Positioned(
                    //   bottom:0,
                    //   child: Icon(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ScoreCard('CORRECT',scores[2],n,),
                          ScoreCard('WRONG', scores[3],n),
                          ScoreCard('SKIPPED', scores[4],n),
                          ScoreCard('TIME', scores[5],d*n),
                        ],
                      ),
                    ],
                  ),
